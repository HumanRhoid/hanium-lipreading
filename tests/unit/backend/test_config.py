...
def test_websocket_timeouts_are_loaded_from_environment(monkeypatch):
    monkeypatch.setenv("SEND_TIMEOUT_SECONDS", "0.25")
    monkeypatch.setenv("STREAM_IDLE_TIMEOUT_SECONDS", "1.5")
    monkeypatch.setenv("MAX_SESSION_SECONDS", "12.0")
...
def test_settings_reject_non_positive_limits(field, value):
    values = {
        "_env_file": None,
        "app_env": "test",
        "database_url": (
